...
#' @param upsimplerArgs List of arguments to be passed to the upsimpler algorithm.
...
#' Must be present in the dataDF and metadataDF in upsimplerArgs.
...
applyUpsimpler <- function(upsimpler,
  ...
  for (i in base::seq_along(targetSampleIDs)) {
    ...
    upsimplerArgs$target_sample_id <- targetSampleID
    synths <- do.call(upsimpler$upsimple, upsimplerArgs)
